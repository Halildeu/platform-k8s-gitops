...
"""
    ...
    def test_consultation_defaults_to_none_then_isolated_codex_and_optional_dual(self):
        ...
        self.assertIn("`other` yalnız receipt taşımayan `none` modunda", self.context_rules)
        ...
        self.assertIn("resmi `@openai/codex` launcher/package/version", self.context_rules)
        self.assertIn("provider-signed model", self.context_rules)
        self.assertIn("Tek ve birincil kanal direct", self.context_rules)
        self.assertIn("Codex exec'i birincil", self.context_rules)
