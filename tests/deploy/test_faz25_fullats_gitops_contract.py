...
"""
    ...
    def test_consultation_defaults_to_none_then_exact_codex_single(self):
        rule = "Durumsal Cross-AI istişare — yalnız direct Codex"
        ...
        self.assertIn("`codex exec --ephemeral --sandbox read-only`", self.agents)
        self.assertIn("`xhigh`", self.agents)
        ...
        self.assertIn("**`single` — kesin review gerektiğinde:**", self.context_rules)
        ...
        self.assertIn("provider/model/effort exact", self.context_rules)
