...
"""
    ...
    def test_consultation_defaults_to_none_then_single_claude_and_max_two(self):
        ...
        self.assertIn("Hypothetical future", self.minimax_wrapper)
        self.assertIn("cannot justify REVISE", self.minimax_wrapper)
        self.assertIn("already rejected by an existing validator", self.minimax_wrapper)
