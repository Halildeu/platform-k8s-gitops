...
const cases = [
  ...
  ['historical Codex v4 evidence rejects a trusted base outside PR-base ancestry',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      ...
      expectedFailureCheck: 'cross_ai_source_trust_activation' }, 1],
  ['none mode treats a post-retirement unledgered OpenAI v1 comment as presentation only',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: CURRENT_CODEX_V1_EVIDENCE }, 0],
  ...
  ['none mode treats a new unledgered Claude v3 comment as presentation only',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: CURRENT_CLAUDE_V3_EVIDENCE }, 0],
  ...
  ['none mode treats unledgered OpenAI v3 after activation as presentation only',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: POST_ACTIVATION_CODEX_V3_EVIDENCE }, 0],
  ...
  ['an edited historical REVISE candidate fails closed',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      ...
      expectedFailureCheck: 'consultation_prior_revise_resolved' }, 1],
  ['an unselected owner comment edited after activation cannot alter immutable authority',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: erasedOwnerHistoryEvidence }, 0],
  ...
  ['an invalid-digest historical REVISE candidate fails closed',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      ...
      expectedFailureCheck: 'consultation_evidence_history_valid' }, 1],
  ['an unledgered edited comment with changed provider cannot alter authority',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: changedProviderHistoricalReviseEvidence }, 0],
  ['an unledgered edited comment with stripped identity cannot alter authority',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: strippedIdentityHistoricalReviseEvidence }, 0],
  ['an immutable retired MiniMax v1 record remains read-only history',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: immutableHistoricalMinimaxV1Evidence }, 0],
  ['a post-retirement unledgered MiniMax v1 comment is presentation only',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: CURRENT_MINIMAX_V1_EVIDENCE }, 0],
  ['a malformed pre-retirement MiniMax v1 record fails closed',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: INVALID_HISTORICAL_MINIMAX_V1_EVIDENCE,
      expectedFailureCheck: 'consultation_evidence_history_valid' }, 1],
  ['a new unledgered MiniMax v3 history comment is presentation only',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: [ROUTINE_PATH],
      evidence: immutableHistoricalMinimaxV3Evidence }, 0],
