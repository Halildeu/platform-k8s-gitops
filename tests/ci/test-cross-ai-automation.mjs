...
const cases = [
  ...
  ['explicit none mode rejects CONTRIBUTING consultation contract changes',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody, changedFiles: ['CONTRIBUTING.md'] }, 1],
  ...
  ['explicit none mode rejects VIEW_ONLY product root schema changes',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: explicitNoneBody,
      changedFiles: ['schema/faz22-6-view-only-viewer-product-evidence-root-v2.schema.json'] }, 1],
  ...
  ['explicit single mode rejects an Anthropic receipt alias',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: `${peerBody}Anthropic receipt: ${CODEX_REF}\n`, changedFiles: [ROUTINE_PATH] }, 1],
  ['explicit single mode rejects a Cursor receipt alias',
    { branch: 'roadmap-827-x', actor: 'halilkocoglu', sender: 'halilkocoglu',
      body: `${peerBody}Cursor receipt: ${CODEX_REF}\n`, changedFiles: [ROUTINE_PATH] }, 1],
