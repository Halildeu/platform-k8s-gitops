...
assert_empty_opts_capture "release-lineage-empty-opts"
SSH_OPTS="-o IdentitiesOnly=yes -i /tmp/faz22-test-key"
...
assert_empty_opts_capture "completion-empty-opts"
