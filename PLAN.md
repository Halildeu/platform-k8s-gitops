...
| **22.5** Software Deployment Quick Wins | Endpoint-Enes agent üzerinden ücretsiz WinGet + Approved Software Catalog tabanlı yazılım inventory/install/uninstall + cihaz posture/health hattı. 22.3 domain-wide mass deployment yerine geçmez; agent yüklendikten sonraki yönetim kabiliyetidir. | Evidence-driven | AG-025/AG-026 read-only inventory + WinGet readiness; AG-030/AG-031/AG-032/AG-033 reboot/security/local-admin/health; BE-020 catalog; AG-027 install; BE-021 detection/audit; WEB-011/WEB-012 UI; AG-034 SMB/file action discovery only | Canonical plan ve runbook eklendi: [`docs/faz-22-software-deployment-plan.md`](./docs/faz-22-software-deployment-plan.md), [`docs/runbooks/RB-faz22-software-deployment-winget.md`](./docs/runbooks/RB-faz22-software-deployment-winget.md). Runtime kabiliyeti iddia edilmez. | Faz 22.2/22.3 ile paralel; source işleri ilgili repolarda | 🟡 PLAN-ONLY (2026-05-27): raw shell yok, katalog dışı package yok, ilk pilot 7-Zip (`7zip.7zip`); SMB/file runtime yok, yalnız discovery/guardrail; source PR'ları henüz başlamadı |
