...
`direct-stt-ca.crt` / `direct-stt-client.crt` / `direct-stt-client.key`, flag
flip, and `/transcribe` result-stream smoke. This does not change #198 full I7,
desktop mic/loopback, product pilot, or production readiness gates.
