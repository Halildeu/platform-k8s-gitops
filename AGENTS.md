...
- **Faz 24 KVKK legal-track parallelism**: KVKK/VERBIS/hukuk owner acceptance mühendislik completion blocker'ı değildir; owner bildirimi kayda alındıktan sonra mühendislik fail-closed, parametrik retention/consent/deletion kontrolleriyle ilerler. Legal acceptance, VERBIS güncelliği veya production legal go yalnız owner/legal kanıtıyla söylenir; agent/CI/PR bunu iddia etmez.
