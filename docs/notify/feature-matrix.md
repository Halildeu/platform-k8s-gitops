...
| A4 | SMS (JetSMS primary, NetGSM secondary) | **MVP-geniş** | 23.3 | 🟢 **FULLY DELIVERED 2026-05-25** (B-with-lanes complete + BL-011 LIVE): M4 prod LIVE 2026-05-20 sha-6307428 + JetSMS primary `SmsAdapter activated` + `JetSmsDlrPollingWorker scheduling=true`; multipart context routing 23.3.2 LIVE; BL-010 prod KC `serban` realm + org_id mapper LIVE (PR #1062); BL-028a Lane A prod DB seed LIVE (PR #1067 — template `canary-prod-marketing-v1` + subscriber `bl028-prod-canary-001` +905551815564); BL-028b Lane B prod OpenFGA notification model cutover LIVE (PR #1069 — new prod model `01KSFFK9K3V43DD211Z79K3FYA` 15 types); **BL-011 prod SMS canary LIVE DELIVERED 2026-05-25 16:58:45 UTC** (PR #1071 — gerçek SMS +905551815564 → JetSMS `jetsms-2605251959362908914` → DELIVERED 71s DLR; 7/7 acceptance gate PASS). **NetGSM secondary R1 ⏳ DEFER asset-preserved** (kullanıcı kararı 2026-05-23; JetSMS-only degraded mode kalıcı işletim durumu). |
