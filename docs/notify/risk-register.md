...
| R9 | D43 outage fallback test fail under real outage | Medium | High | **Medium** | D43 implementation 23.2.D + drill execution + runbook | ops | 🔴 Pending | 23.2.D | 2026-05-09 |
...
| R13 | Webhook fan-out cap exhausted → DLQ flood | Medium | Medium | **Medium** | T1.6 abuse guards LIVE 2026-05-09 (AbuseGuardService 240 satır + webhookFanoutCap=10 HARD safety limit + 8/8 unit tests; PR #134 MERGED + cluster pod imageID sha256:eef18027 LIVE; AbuseGuardService initialized log evidence) | dev | 🟢 Mitigated | 23.2.F | 2026-05-09 |
...
| R19 | Mass notification sending storm (abuse / compromised key) | Low | Critical | **Medium** | T1.6 abuse guards LIVE 2026-05-09 (sliding window rate limit 100/window per (orgId, topicKey); 60s window; critical bypass dar scope; PR #134 MERGED + AbuseGuardService initialized: window=60s rateLimit=100/window evidence) | ops | 🟢 Mitigated | 23.2.F | 2026-05-09 |
