...
> - T4.3 actual ~14.5h done of ~36h plan; ~8h kalır (T4.3.5 FBL + T4.3.7 per-template; T4.3.8 federation design-LIVE 2026-05-22 ADR-0026 — production federation Faz 24+/M8)
...
| **T4** 23.6+23.7+23.8 v1 | Teams + WebPush (browser-only) + Tempo + bounce + per-tenant dashboard + federation design | ~99h estimate / ~60.5h actual + ~8h residual (T4.3.5 FBL + T4.3.7 per-template; T4.3.8 design-LIVE 2026-05-22 ADR-0026); mobile FCM/APNS ~24h Faz 22.2 dep DIŞI — Session 47-48 re-baseline 2026-05-21 + 2026-05-22 (T4.1 + T4.2 browser-only 11 sub-PR + #649 UI integration MERGED + T4.3.a Tempo + T4.3.b suppression + T4.3.6 per-tenant dashboard MERGED + T4.3.8 federation design-LIVE 2026-05-22) | ~1 hafta residual | R11 ~mitigated (Tempo LIVE), R16 design-managed (ADR-0026 + budget/rollback dokümante; production federation Faz 24+/M8) |
| **T5** 23.X v2 | multi-tenant features | ~144h | 8-12 hafta | R10 (multi-tenant migration) |
| **Total v1 (T1-T4)** | Faz 23.0 → 23.9 v1 closure | **~8h agent-actionable residual** (T4.3.5 + T4.3.7 backend + gitops; T4.3.8 design-LIVE 2026-05-22 ADR-0026); T1/T2/T3 source-side LIVE; M1 T2.3 5/6 operator+user external (R7); M3 R2 KVKK legal 2026-05-25; M4 R1/R24 + canary KC org_id ext-gated; mobile FCM/APNS ~24h Faz 22.2 dep **DIŞI**. Session 47-48 re-baseline 2026-05-21 + 2026-05-22 — önceki Session 41 ~17-22h Tier 1 residual + Tier 2/3/4 dahil 100-130h → ~8h agent + external acceptance gates | **~1 hafta agent + 3 gün external** (R2 KVKK 2026-05-25) | — |
