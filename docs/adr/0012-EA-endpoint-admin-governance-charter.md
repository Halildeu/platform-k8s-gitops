...
| **22.5.4 residual** | `AG-027L` installer exit-code/redacted log capture | **SOURCE-MERGED (platform-agent PR #32 `4f5e152`, 2026-05-29 PM); live binary verification on HALILKOOLUB735 pending** |
