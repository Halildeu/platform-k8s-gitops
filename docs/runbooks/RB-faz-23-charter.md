...
| **23.4** | v1 — DLR + in-app UI | code | 2 hafta | 23.3 | 🟡 partial (PR-5.x cycle in-app inbox + SSE LIVE + strict identity guards LIVE; **SMS DLR backend ECOSYSTEM source-ready Session 44**: PR #85 DlrController + DlrIngestService + permitAll + 19 backend tests MERGED 2026-05-07; PR #154 api-gateway permitAll gap closed Codex `019e1440` AGREE + 7 yeni gateway test; **archive UI + 30-day history + DLR live smoke (NetGSM contract R1 ETA 2026-05-30 external dep) pending**) |
