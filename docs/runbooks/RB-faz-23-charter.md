...
| 23.7 | v1 — push (FCM/APNS) | code | 2 hafta | 23.4 + Faz 22.2 | 🟡 partial (WebPush browser-only LIVE — PR-W1..W7 + #648/#649 frontend + #652 RTK fetchfn fix + #986/#987 deploy + #990 OpenFGA model extension safe-phase; subscribe akışı browser-kanıtlı RB-webpush §3.10 ✅; §3.11 SUCCESS push delivery OpenFGA model_id cutover bekliyor; mobil FCM/APNS Faz 22.2 dep DIŞI) |
