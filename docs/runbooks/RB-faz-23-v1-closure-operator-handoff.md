...
- [ ] **BL-011** Prod SMS functional canary smoke — canonical canary example: `RB-prod-canary-kc-claim-setup.md` — 🟢 **ELIGIBILITY OPEN 2026-05-25 (iki gate PASS)**: prod `notify_db` data seed ✅ Lane A LIVE (BL-028a PR #1067 MERGED) + prod OpenFGA notification model cutover ✅ Lane B LIVE (BL-028b 2026-05-25 M4.6 trigger). Layer-2 fail-closed kalktı. SMS POST için ayrı operator authorization gate. 6 trigger condition:
