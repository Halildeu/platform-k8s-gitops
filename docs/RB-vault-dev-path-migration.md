...
Service: vault-cluster kv mount path (Faz 17 dev parity)
Status: Canonical (gitops authoritative)
Owner: @team/platform

> **Provenance:** platform-ssot `docs/04-operations/RUNBOOKS/RB-vault-dev-path-migration.md` → migrated as-is (Faz 18.4 Phase 1). Faz 17 local-dev three-realm izolasyon (ADR-0002 + D34) ile birlikte okunmalı.
