...
- **api-gateway D30 drift** — 2026-05-22 delta'dan devralındı; live `sha256:6137bb2c…` ≠ desired `sha256:84500b5e…`, route 401 fail-closed OK, drift-correction PR henüz açılmadı.
