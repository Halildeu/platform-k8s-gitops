...
| Backend source | `BE-020` approved catalog, `BE-020I` software inventory ingest/query ve `BE-021` detection/audit yok |
| Web source | `WEB-011` software/WinGet readiness view yok; mevcut `InventoryTab` software payload parse etmiyor |
