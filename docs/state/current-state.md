...
| Canonical artifact | **Current pin: v0.1.1-lab.2.** `https://testai.acik.com/artifacts/endpoint-agent/v0.1.1-lab.2/EndpointAgent.zip` returns HTTP 200, Content-Type `application/zip`, Content-Length `3245439`, ZIP SHA256 `b88c710d569b74d0fe902434dc2f368bc7fdf99a5d0557190ebc8652f5a7d0fe` == `.sha256` sidecar; `bootstrap-package.ps1` served as PowerShell (Content-Type `application/octet-stream`, BOM+`<#`, not SPA HTML); missing path → 404; image digest `sha256:7ac0fd57ef00d7cc68258cda30eba0a2a1b1ed4a94534f8d96bf92cb4e48f764` (live re-verified 2026-06-09T14:35Z). Earlier capture (#107 era) served `0.1.0-dev` ZIP SHA `9dcf6c2cab5a7dd1fef16a230f065540e1f2d639e0031038e3fbd8d0a9d26029` (standalone `bootstrap-package.ps1` `7ac13aad…`, `SHA256SUMS` matched, scripts carry `/api/v1/endpoint-agent` not stale `/api/v1/endpoint-admin`); the `0.1.0-dev` path now 404s after the lab.1→lab.2 rollover (retention contract §3: host serves only the current pinned version). | Manual ZIP transfer is no longer required for HMAC pilot bootstrap; hidden token prompt still remains on the HMAC fallback path. Canonical served version rolled `0.1.0-dev` (#107) → `v0.1.1-lab.2`; this supersedes the earlier #106 ZIP SHA `88af3d2539c1c0a8a0fcf9525e38238d7816d02eb2f1c3789725b771fe088cf0` |
