...
- `platform-ai#198` için Denetim 8243 app-mTLS immediate preflight PASS kanıtı vardır: staging-sw source route `10.99.0.1 -> 10.99.0.2`, TCP/8243 reachable, valid client cert `/health` HTTP 200, no-client/wrong-client fail-closed. Ancak full I7 prod-gate hâlâ meeting-ai 8343, Vault PKI rotation, request audit, plaintext-bypass closure, failure drill ve reviewer/operator acceptance ister.
