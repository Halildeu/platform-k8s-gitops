...
case "${1:-status}" in
  ...
  session) exec ssh -t "$host" "tmux new-session -A -s platform-dev -c $root" ;;
  ...
  preview)
    ...
    forwards=()
    for port in 33000 33001 33002 33004 33005 33006 33007 33008 33009 33010 33011 33081; do
