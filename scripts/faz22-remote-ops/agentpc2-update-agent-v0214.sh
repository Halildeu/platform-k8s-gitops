...
EXPECTED_AGENT_VERSION="${EXPECTED_AGENT_VERSION:-0.2.26}"
POLL_SECONDS="${POLL_SECONDS:-900}"
POLL_INTERVAL_SECONDS="${POLL_INTERVAL_SECONDS:-15}"

RELEASE_ID="${RELEASE_ID:-v0.2.26}"
TARGET_VERSION="${TARGET_VERSION:-0.2.26}"
BINARY_URL="${BINARY_URL:-https://github.com/Halildeu/platform-agent/releases/download/v0.2.26/endpoint-agent.exe}"
MANIFEST_URL="${MANIFEST_URL:-https://github.com/Halildeu/platform-agent/releases/download/v0.2.26/release-manifest.json}"
EXPECTED_SHA256="${EXPECTED_SHA256:-66b0fb98deb63e175c2e37fbf4ff78af98803bf66a84b11ac3667b21a5bf5bb8}"
