...
EXPECTED_AGENT_VERSION="${EXPECTED_AGENT_VERSION:-0.2.27}"
POLL_SECONDS="${POLL_SECONDS:-900}"
POLL_INTERVAL_SECONDS="${POLL_INTERVAL_SECONDS:-15}"

RELEASE_ID="${RELEASE_ID:-v0.2.27}"
TARGET_VERSION="${TARGET_VERSION:-0.2.27}"
BINARY_URL="${BINARY_URL:-https://github.com/Halildeu/platform-agent/releases/download/v0.2.27/endpoint-agent.exe}"
MANIFEST_URL="${MANIFEST_URL:-https://github.com/Halildeu/platform-agent/releases/download/v0.2.27/release-manifest.json}"
EXPECTED_SHA256="${EXPECTED_SHA256:-ea99347adb64f43c1f1b921f6b6a1ebfa1c1ddcd1598acddea87cd6b8ab35a8f}"
