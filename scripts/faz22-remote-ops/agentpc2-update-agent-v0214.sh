...
EXPECTED_AGENT_VERSION="${EXPECTED_AGENT_VERSION:-0.2.25}"
POLL_SECONDS="${POLL_SECONDS:-900}"
POLL_INTERVAL_SECONDS="${POLL_INTERVAL_SECONDS:-15}"

RELEASE_ID="${RELEASE_ID:-v0.2.25}"
TARGET_VERSION="${TARGET_VERSION:-0.2.25}"
BINARY_URL="${BINARY_URL:-https://github.com/Halildeu/platform-agent/releases/download/v0.2.25/endpoint-agent.exe}"
MANIFEST_URL="${MANIFEST_URL:-https://github.com/Halildeu/platform-agent/releases/download/v0.2.25/release-manifest.json}"
EXPECTED_SHA256="${EXPECTED_SHA256:-0bf8aada0bf7b25f3e574e576a8401f9030168cbe60a487d6f6c5a6d4c610aec}"
EXPECTED_SIGNER_THUMBPRINT="${EXPECTED_SIGNER_THUMBPRINT:-D68F4F530137EB65CE44E3405E82B46205E753E5}"
MAX_BYTES="${MAX_BYTES:-14376360}"
