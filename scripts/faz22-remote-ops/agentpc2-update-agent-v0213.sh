...
# Faz 22.6.3 / platform-agent#208 AgentPC2 v0.2.13 product update gate.
#
...
main() {
  ...
  EVIDENCE_DIR="${EVIDENCE_DIR}/seed" \
    ...
    MAX_BYTES="$MAX_BYTES" \
    RELEASE_NOTES="Faz 22.6.3 AgentPC2 v0.2.13 seed for platform-agent#208" \
