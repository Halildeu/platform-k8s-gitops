...
#
# Single source of truth: bootstrap/openfga/meeting-transcript-tuples.json.
...
#   TUPLES_JSON=/tmp/meeting-transcript-tuples.json ./...-seed.sh
#
# Env contract:
#   TUPLES_JSON   — optional; path to the tuples JSON. Default: resolved relative
#                   to this script (../../bootstrap/openfga/meeting-transcript-tuples.json).
...
TUPLES_JSON="${TUPLES_JSON:-${SCRIPT_DIR}/../../bootstrap/openfga/meeting-transcript-tuples.json}"
